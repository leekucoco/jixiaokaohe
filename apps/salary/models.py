...
class SalaryRecord(models.Model):
    ...
    extrainfo = models.TextField(verbose_name="备注", default=str(date.today().month)+"月工资记录")
...
class FSalary(models.Model):
    ...
    depart = models.CharField(max_length=30, null=True, blank=True, verbose_name="机构")
